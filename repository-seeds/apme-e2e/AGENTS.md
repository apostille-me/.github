...
Follow the organization-wide branching, semantic-conflict, security, and evidence rules in `apostille-me/.github`.

- Preserve the canonical repository identity `apostille-me/apme-e2e`; never create a long-name duplicate.
